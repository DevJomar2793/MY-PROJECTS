...
<template>
  <div class="min-vh-100 d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #0f0c29, #302b63, #24243e);">
    <div class="w-100" style="max-width: 420px; padding: 0 20px;">

      <!-- Logo / Brand -->
      <div class="text-center mb-4">
        <div class="d-inline-flex align-items-center justify-content-center rounded-4 mb-3" style="width:60px;height:60px;background:rgba(255,255,255,0.1);backdrop-filter:blur(10px);">
          <i class="bi bi-box-seam-fill text-white fs-3"></i>
        </div>
        <h4 class="text-white fw-bold mb-1">CKT Hardware Inventory</h4>
        <p class="text-white-50 small">Sign in to access your inventory system</p>
      </div>
      ...
      <div class="card border-0 rounded-4 shadow-lg" style="background:rgba(255,255,255,0.95);backdrop-filter:blur(20px);">
        <div class="card-body p-4 p-md-5">
          ...
          <form @submit.prevent="handleLogin">
            ...
            <div class="mb-4">
              <div class="d-flex justify-content-between">
                ...
                <router-link to="/forgot-password" class="small text-primary text-decoration-none">Forgot password?</router-link>
              </div>
              <div class="input-group">
                <span class="input-group-text bg-light border-end-0 rounded-start-3 border text-muted">
          ...
          <p class="text-center text-muted small mb-0">
            ...
            <router-link to="/signup" class="text-primary fw-semibold text-decoration-none">Create one</router-link>
          </p>
        </div>
      </div>
