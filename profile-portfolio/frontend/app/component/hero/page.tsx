    ...
    <section className="relative min-h-[90vh] flex items-center justify-center text-center pt-20 px-4">
      <div className="flex flex-col items-center z-10">
        <div className="relative group mb-8">
          {/* Glowing Aura Effect */}
          <div className="absolute -inset-2 bg-gradient-to-r from-violet-600 to-blue-600 rounded-full blur-lg opacity-20 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
          <img
