...
export default function Home() {
  return (
    <main className="flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,#e0f2fe_0%,#eef4ff_35%,#ffffff_100%)] px-6 py-12 transition-colors dark:bg-[radial-gradient(circle_at_top,#1e293b_0%,#0f172a_35%,#020617_100%)]">
      <div className="absolute left-[-6rem] top-16 h-40 w-40 rounded-full bg-cyan-300/30 blur-3xl dark:bg-cyan-500/10" />
      <div className="absolute bottom-10 right-[-4rem] h-56 w-56 rounded-full bg-indigo-300/40 blur-3xl dark:bg-indigo-500/10" />

      <section className="relative z-10 w-full max-w-5xl rounded-[2rem] border border-white/60 bg-white/75 p-8 shadow-[0_30px_80px_rgba(37,99,235,0.18)] backdrop-blur-xl transition-colors dark:border-slate-800/80 dark:bg-slate-900/80 dark:shadow-[0_30px_80px_rgba(2,6,23,0.55)] sm:p-10">
          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-xl text-base leading-7 text-slate-600 dark:text-slate-300 sm:text-lg">
                Test your frontend knowledge with timed multiple-choice
                questions, instant progression, and a final score summary when
                the challenge ends.
              </p>
            </div>
